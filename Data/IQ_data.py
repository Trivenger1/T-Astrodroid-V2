...
prompts2 = [
    ...
    "{A}: FUCK YOU!!<br>{B}: FUCK YOU!!!<br>{A}: **FUCK YOU,I'LL SEE YOU TOMORROW**",
    "{A}, whose first language isn’t English: Hello! I’m sorry if my English isn’t very good.<br>{B}, whose first language is English: hte fuckign",
    "{A}: Get out of the chair.\n{B}: Maybe you could reconsider how you’re asking.\n{A}:  \n{A}: Get the *fuck* out of the chair.",
    "{A}: Oh hey, {B}… What are you doing here?\n{B}: On the contrary, what are ***you*** doing *here*? This is my house, after all.",
    "{A}: *Approaches {B} while holding a bowl of hot soup* \n{A}: Alright,you're gonna have to blow.\n{B} after thinking for a second: *shrugs* Eh alright"
    "\n{B}: *Gets down on their knees*\n{A}: **I MEANT THE FUCKING SOUP** ",
  ]
...
prompts3 = [
    ...
    "{A}: HELP! I TOLD {C} I’D COOK DINNER TONIGHT BUT I CAN’T COOK! <br> {B}, pouring milk directly into the cereal bag: And you thought I could help?",
    ...
    "{A}: If you had to choose between {B} and all the money I have in my wallet, which would you choose? <br> {C}: That depends, how much money are we taking about? <br> {B}: {C}! <br> {A}: 63 cents. <br> {C}: I'll take the money. <br> {B}: <b><i>{C}!!!</b></i>",
    ...
    "{A}, negotiating with {B}: We have {C}. Give us ten thousand dollars and they will be returned to you unharmed<br>{C}: Whoa, whoa, wait, you think I’m only worth ten thousand dollars?<br>{A}:<br>{C}: MAKE IT ONE MILLION–<br>{A}: {C} STOP",
    ...
    "{A}: I’m dating {B}.<br>{C}: I always knew your standards were low, but not that low.",
  ]
...
prompts4 = [
    ...
    "{A}: You lying, cheating, piece of shit!<br>{B}: Oh yeah? You’re the idiot who thinks you can get away with everything you do. WELCOME TO THE REAL WORLD<br>{A}: I’m leaving you, and I’M TAKING {C} WITH ME<br>{D}, picking up the monopoly board: I think we’re gonna stop playing now.",
...
prompts6 = [
    ...
    "{A}: Who the fuck added me to a fucking group chat? <br> {B}: >:O language <br> {C}: Yeah watch your fucking language <br> {D}: OKAY WHO TAUGHT {C} THE FUCK WORD? <br> {E}: 'The fuck word'. <br> {F}: Are you stupid? You guys use the f word all the time <br> {C}: Oh my god they censored it <br> {E}: Say fuck, {F}. <br> {C}: Do it, {F}. Say fuck.",
...
prompt_list = [prompts1,prompts2,prompts3,prompts4,prompts5,prompts6]